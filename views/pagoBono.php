...
<head>
    ...
    <link rel="stylesheet" href="./css/estiloPagoBono.css">
    <title>Pago_Bono</title>
</head>
        ...
        <section class="navbar aside">
            ...
            <div class="container-fluid">
                <ul class="opciones">
                    ...
                    <li>
                        <a class="active" href="pagoBono.php"><i class="fab fa-btc"></i> &nbsp; REGISTRAR PAGO DE BONO</a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                <form action="" class="formularioPago" autocomplete="off">
                    <fieldset>
                        <legend><i class="fas fa-plus fa-fw"></i> &nbsp; Nuevo Pago de Bono</legend>
                        <div class="container-fluid">
                            <div class="row datosEmpleado">
                                ...
                                <div class="col-6 col-md-3">
                                    <div class="form-group">
                                        <label for="pago_bono" class="bmd-label-floating">Monto Pago</label>
                                        <input type="text" pattern="[0-9.]{3,6}" class="form-control" name="pago_bono" id="pago_bono input" maxlength="6" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-floating">
                                    <label for="detalle_bono" class="bmd-label-floating">Detalle</label>
