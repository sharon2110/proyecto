...
<head>
    ...
    <link rel="stylesheet" href="./css/estiloPagoProveedor.css">
    <title>Pago_Proveedor</title>
</head>
        ...
        <section class="navbar aside">
            ...
            <div class="container-fluid">
                <ul class="opciones">
                    ...
                    <li>
                        <a class="active" href="pagoProveedor.php"><i class="fas fa-id-card"></i> &nbsp; REGISTRAR PAGO A PROVEEDOR</a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                <form action="" class="formularioPago" autocomplete="off">
                    <fieldset>
                        <legend><i class="fas fa-plus fa-fw"></i> &nbsp; Nuevo Pago a Proveedor</legend>
                        <div class="container-fluid">
                            <div class="row datosProveedor">
                                ...
                                <div class="col-6 col-md-3">
                                    <div class="form-group">
                                        <label for="pago_prov" class="bmd-label-floating">Monto Pago</label>
                                        <input type="text" pattern="[0-9.]{3,6}" class="form-control" name="pago_prov" id="pago_prov input" maxlength="6" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-floating">
                                    <label for="detalle_prov" class="bmd-label-floating">Detalle</label>
                                    <textarea class="form-control" pattern="[a-zA-Z\s.,]{10,150}" placeholder="Detalles" id="" style="height: 100px; margin-top:50px;" required></textarea>
                                </div>
