...
<body>
    <main class="contenedorPrincipal">
        ...
        <section class="navbar aside">
            ...
            <div class="container-fluid">
                <ul class="opciones">
                    <li>
                        <a class="active" href="nuevoCredito.php" sstyle="font-size:15.5px!important;"><i
                                class="fas fa-plus fa-fw"></i> &nbsp; NUEVO
                            TRÁMITE</a>
                    </li>
                    <li>
                        <a href="listaTramites.php" style="font-size:15.5px!important;"><i
                                class="fas fa-clipboard-list fa-fw"></i>&nbsp;LISTA DE TRÁMITES
                        </a>
                    </li>
                    <li>
            ...
            <!-- TABLA REGISTRO-->
            <div class="container-fluid">
                <form action="" class="formularioTramite" id="id_reg_tramite" autocomplete="off" method="POST"
                    enctype="multipart/form-data">
                    <fieldset>
                        <legend><i class="fas fa-folder-plus"></i> &nbsp; Nuevo Trámite
                        </legend>
                        <div class="container-fluid">
                            <div class="row" style="text-align:center;">
                                <input type="text" name="id" id="id_cliente" maxlength="16" value="" hidden>
                                <input type="text" name="id" id="id_usuario" maxlength="16" value="<?php echo $idusu ?>"
                                    hidden>
                                                    ...
                                                    <div class="col-12 col-md-12">
                                                        <div class="form-group">
                                                            <label for="inputSearch"
                                                                class="bmd-label-floating labelBusqueda" id="labelCi"
                            ...
                            <div class="row datosBanco">
                                <div class="col-12 col-md-4">
                                    <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalCliente"
                                        type="button" name="btnAdCliente" id="idbtnAdCliente"
                                        style="width:40%; padding:5px;margin-top:5px;"> <i
                                            class="fas fa-user-plus fa-xs"></i></button>
                                    <div class="table-responsive contenedorTabla tablaresbusCI" id="idtablabusCI"
                                        style="display:none;">
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group bancoMonto">
                                        <label for="nom_banco" class="bmd-label-floating titulo">Banco</label>
                                        <select class="form-select" id="selec_banco" required name="sel_banco"
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group bancoMonto" style="font-size:13px!important;">
                                        <label for="monto_prestamo" class="bmd-label-floating titulo"
                                            style="font-size:small!important;">Monto
                                            Préstamo</label>
                            ...
                            <div class="row datosBanco">
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        <label for="asesor_credito" class="bmd-label-floating titulo"
                                            style="font-size:13px!important;">Asesor de crédito
                                        </label>
                                        <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]{10,200}" class="form-control"
                                            name="asesor_credito" id="id_asesor_credito" maxlength="200" required
                                            style="font-size:14px;">
                                    </div>
                                </div>

                                <div class="col-12 col-md-4">
                                    <div class="form-group" style="font-size:13px!important;">
                                        <label for="sucursal_banco" class="bmd-label-floating titulo">Sucursal
                                        </label>
                                        <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ\s.#]{7,200}"
                                            class="form-control" name="sucursal_banco" id="id_sucursal_banco"
                                            maxlength="200" required style="font-size:14px;">
                                    </div>
                                </div>

                                <div class="col-12 col-md-4">
                                    <div class="form-group" style="font-size:13px!important;">
                                        <label for="observacion_tramite" class="bmd-label-floating titulo">Observación
                                        </label>
                                        <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ\s]{10,200}"
                                            class="form-control" name="observacion" id="id_observacion" maxlength="200"
                                            style="font-size:14px;">
                                    </div>
                                </div>
                            </div>
                            <div class="justify-content-center table-responsive" style="padding:0px; margin-top:20px;">
                                <table class="table tablaOpciones">
                                    <thead>
                                        <tr class="text-center" style="font-size:13px;border:0;">
                                            <th><label>Ver vehículos</label></th>
                                            <th><label>Añadir vehículos</label></th>
                                        ...
                                        <tr class="text-center">
                                            <td class="text-center"><button class="btn btn-danger botonOpciones"
                                                    type="button" data-bs-toggle="modal" data-bs-target="#modalV"><i
                                                        class="fas fa-car fa-sx"></i></button></td>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable modal-lg modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" style="font-size:16px;">Lista de vehiculos</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="table-responsive justify-content-center contenedorTabla tablaresbusM col-12 col-md-12"
                                ...
                                <div class="modal fade" id="modalVadd" tabindex="-1" aria-labelledby="modelTitleId"
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable modal-lg modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" style="font-size:16px;">Añadir vehículo</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                                        ...
                                                        <div class="col-12 col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="modelo" class="form-select"
                                                                    id="modelo_selec" style="font-size:14px;">
                                                                    <option value="" selected>Seleccionar</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-12 col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="color" class="form-select"
                                                                    id="color_selec" style="font-size:14px;">
                                                                    <option value="" selected>Seleccionar</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="numpas" class="form-select"
                                                                    id="numpas_selec" style="font-size:14px;">
                                                                    <option value="" selected>Seleccionar</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" pattern="[0-9]{1,2}"
                                                                    class="form-control" required name="num_otro"
                                                                    id="num_autoOtro" maxlength="2" disabled
                                                                    style="font-size:14px;">
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-md-3">
                                                        ...
                                                        <div class="col-12 col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="precio" class="form-select"
                                                                    id="precio_selec" style="font-size:14px;">
                                                                    <option value="" selected>Seleccionar</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="modal-body">
                                            <div class="row justify-content-center">
                                                <div class="col-12" style="margin:30px; width:200px;">
                                                    ...
                                                    <button type="button" class="col-2 btn btn-danger center-block"
                                                        ...
                                                        id="quitaCContrato" disabled>Quitar</button>
                                                </div>
                                                ...
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    <div class="container card col-12 col-md-3" id="perfilCCarnet">
                                                        ...
                                                        <div class="card-footer">
                                                            <span>Fotocopia de Carnet</span>
                                                        </div>
                                                    </div>
                                                    <button type="button" class="col-2 btn btn-danger center-block"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaCCarnet" disabled>Quitar</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-md-2 btn btn-danger"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaCFacLuz" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-md-2 btn btn-danger"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaCFacAgua" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-md-2 btn btn-danger"
                                                        ...
                                                        id="quitaCCroquis" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-md-2 btn btn-danger"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaCFolio" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-md-2 btn btn-danger"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaCTestimonio" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-md-2 btn btn-danger"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaCImpuesto" disabled>Quitar</button>
                                                </div>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-md-2 btn btn-danger"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaCRuat" disabled>Quitar</button>
                                                </div>
                                                ...
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-md-2 btn btn-danger"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaCSoat" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-md-2 btn btn-danger"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaCNit" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-md-2 btn btn-danger"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaCPatente" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-md-2 btn btn-danger"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaCBoletaPago" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-md-2 btn btn-danger"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaCAfp" disabled>Quitar</button>
                                                </div>

                                                <div class="col-12"
                                                    style="background-color:brown; color:white; margin:15px;padding:8px;font-size:15px;">
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-md-2 btn btn-danger"
                                                            style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                            id="quitaCPlanPago1" disabled>Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-md-2 btn btn-danger"
                                                            style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                            id="quitaCBoletaCancelacion1" disabled>Quitar</button>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-8">
                                                    <div class="form-group">
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-md-2 btn btn-danger"
                                                            style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                            id="quitaCPlanPago2" disabled>Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        <div class="container card col-md-3 "
                                                        ...
                                                        <button type="button" class="col-md-2 btn btn-danger"
                                                            style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                            id="quitaCBoletaCancelacion2" disabled>Quitar</button>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-8">
                                                    <div class="form-group">
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-md-2 btn btn-danger"
                                                            style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                            id="quitaCPlanPago3" disabled>Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        <div class="container card col-md-3 "
                                                        ...
                                                        <button type="button" class="col-md-2 btn btn-danger"
                                                            style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                            id="quitaCBoletaCancelacion3" disabled>Quitar</button>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-8">
                                                    <div class="form-group">
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-md-2 btn btn-danger"
                                                            style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                            id="quitaCPlanPago4" disabled>Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        <div class="container card col-md-3 "
                                                        ...
                                                        <button type="button" class="col-md-2 btn btn-danger"
                                                            style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                            id="quitaCBoletaCancelacion4" disabled>Quitar</button>
                                                    </div>
                            ...
                            <!-- MODAL LISTA DE DOCUMENTOS CLIENTE -->
                                            ...
                                            <div class="row">
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <label style="color:rgb(0, 0, 0)!important;font-weight:normal;font-size:14px!important;">
                                                            Contrato de trámite
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <!-- TABLA DEUDAS-->
                                                <div class="col-12"
                                                    style="background-color:brown; color:white; font-size:14px; padding:8px;margin:auto;">
                                                    Deudas con otros bancos</div>
                                                <br>
                                                                ...
                                                                <td>
                                                                    <div class="form-group col-10">
                                                                        <select class="form-select"
                                                                            ...
                                                                            name="selec_deuda_cliente1" id="bancod1"
                                                                            style="font-size:14px;">
                                                                            <option value="0">Seleccionar</option>
                                                                            <?php
                                                                            require_once '../scripts/conexion.php';
                                                            ...
                                                            <tr class="text-center">
                                                                ...
                                                                <td>
                                                                    <div class="form-group col-10">
                                                                        <select class=" form-select"
                                                                            aria-label="Default select example"
                                                                            name="selec_deuda_cliente2" id="bancod2"
                                                                            style="font-size:14px;">
                                                                            <option value="0">Seleccionar</option>
                                                                            <?php
                                                                            require_once '../scripts/conexion.php';
                                                            ...
                                                            <tr class="text-center">
                                                                ...
                                                                <td>
                                                                    <div class="form-group col-10">
                                                                        <select class=" form-select"
                                                                            aria-label="Default select example"
                                                                            name="selec_deuda_cliente3" id="bancod3"
                                                                            style="font-size:14px;">
                                                                            <option value="0">Seleccionar</option>
                                                                            <?php
                                                                            require_once '../scripts/conexion.php';
                                                            ...
                                                            <tr class="text-center">
                                                                ...
                                                                <td>
                                                                    <div class="form-group col-10">
                                                                        <select class=" form-select"
                                                                            aria-label="Default select example"
                                                                            name="selec_deuda_cliente4" id="bancod4"
                                                                            style="font-size:14px;">
                                                                            <option value="0">Seleccionar</option>
                                                                            <?php
                                                                            require_once '../scripts/conexion.php';
                                        ...
                                        <div class="modal-body">
                                            <div class="row justify-content-center">
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-2 btn btn-danger center-block"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaGCarnet" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-2 btn btn-danger center-block"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaGFacLuz" disabled>Quitar</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-2 btn btn-danger center-block"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaGFacAgua" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-2 btn btn-danger center-block"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaGCroquis" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-2 btn btn-danger center-block"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaGFolio" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-2 btn btn-danger center-block"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaGTestimonio" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-2 btn btn-danger center-block"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaGImpuesto" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-2 btn btn-danger center-block"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaGRuat" disabled>Quitar</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-2 btn btn-danger center-block"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaGSoat" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;;">
                                                    ...
                                                    <button type="button" class="col-2 btn btn-danger center-block"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaGNit" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-2 btn btn-danger center-block"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaGPatente" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-2 btn btn-danger center-block"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaGBoletaPago" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12" style="margin:30px;width:200px;">
                                                    ...
                                                    <button type="button" class="col-2 btn btn-danger center-block"
                                                        style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                        id="quitaGAfp" disabled>Quitar</button>
                                                </div>
                                                <div class="col-12"
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block"
                                                            style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                            id="quitaGPlanPago1" disabled>Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        <div class="container card col-md-3 "
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block"
                                                            style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                            id="quitaGBoletaCancelacion1" disabled>Quitar</button>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-8">
                                                    <div class="form-group">
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block"
                                                            style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                            id="quitaGPlanPago2" disabled>Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        <div class="container card col-md-3 "
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block"
                                                            style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                            id="quitaGBoletaCancelacion2" disabled>Quitar</button>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-8">
                                                    <div class="form-group">
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block"
                                                            style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                            id="quitaGPlanPago3" disabled>Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block"
                                                            style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                            id="quitaGBoletaCancelacion3" disabled>Quitar</button>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-8">
                                                    <div class="form-group">
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block"
                                                            style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                            id="quitaGPlanPago4" disabled>Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block"
                                                            style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;"
                                                            id="quitaGBoletaCancelacion4" disabled>Quitar</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <!-- MODAL LISTA DE DOCUMENTOS GARANTE -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" style="margin-top: 10px;">
                                            <div class="row">
                                                ...
                                                <!-- TABLA DEUDAS-->
                                                <div class="col-12"
                                                    style="background-color:brown; color:white; font-size:14px; padding:12px;">
                                                    Deudas con otros bancos</div>
                                                <br>
                                                <div class="table-responsive contenedorTabla" style="margin-top: 10px;">
                                                    <table class="table table-sm tabla">
                        ...
                        <p class="text-center" style="margin-top: 40px;">
                            <button type="submit" class="btn btn-success" style="padding:7px;font-size:14px;"><i
                                    class="far fa-save"></i> &nbsp;
                                GUARDAR</button>
                        </p>
            </div>
    ...
    <script src="js/limpiarTramite.js"></script>
