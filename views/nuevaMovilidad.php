...
<body>
            ...
            <div class="container-fluid">
                <form action="" class="formularioRegMovilidad" autocomplete="off" id="registroAuto">
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" aria-label="Default select example" required
                                            name="selecproveedor" style="font-size:15px;">
                                            <option value="" selected>Seleccionar</option>
                                            <option value="1">XIAMEN KING LONG UNITED AUTOMOTIVE</option>
                                            <option value="2">FUJIAN NEW LONGMA AUTOMOTIVE CO.,LT.</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        <label for="precio_compra" class="bmd-label-floating">Precio
                                            Compra</label>
                                        <input type="text" pattern="[0-9]{5,7}" class="form-control"
                                            name="precio_compra" id="precio_compra input" maxlength="7" required
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        <label for="precio_minventa" class="bmd-label-floating">Precio
                                            Mín.Venta</label>
                                        <input type="text" pattern="[0-9]{5,7}" class="form-control"
                                            name="precio_minventa" id="precio_minventa input" maxlength="7" required
                                            style="font-size:15px;">
                                    </div>
                                </div>
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" pattern="[0-9]{5,7}" class="form-control" name="precio_venta"
                                            id="precio_venta input" maxlength="7" required style="font-size:15px;">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-12 col-md-2" style="margin-top:30px;">
                                    <button class="btn btn-danger" type="button" style="font-size:15px;"
                                        data-bs-toggle="modal" data-bs-target="#modalColores">Colores</button>
                                </div>
                                <div class="col-12 col-md-4">
                                    ...
                                    <button type="button" class="col-2 btn btn-danger botonQuitaFotoV" id="quitaFotoV"
                                        hidden>
                                        <i class="fas fa-trash fa-xs"></i></button>
                                </div>
                            </div>
                            <div class="modal fade" id="modalColores" tabindex="-1" aria-labelledby="modelTitleId"
                                aria-hidden="true">
                                                                    ...
                                                                    <div class="col-2 col-md-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                style="border: 1px solid rgb(51, 49, 49); margin-left:0px;"
                                                                                type="checkbox" value=""
                                                                                name="color_uno" id="color_uno_id">
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <div class="col-2 col-md-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                style="border: 1px solid rgb(51, 49, 49); margin-left:0px;"
                                                                                type="checkbox" value=""
                                                                                name="color_dos" id="color_dos_id">
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <div class="col-2 col-md-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                style="border: 1px solid rgb(51, 49, 49); margin-left:0px;"
                                                                                type="checkbox" value=""
                                                                                name="color_tres" id="color_tres_id">
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <div class="col-2 col-md-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                style="border: 1px solid rgb(51, 49, 49); margin-left:0px;"
                                                                                type="checkbox" value=""
                                                                                name="color_cinco" id="color_cinco_id">
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <div class="col-2 col-md-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                style="border: 1px solid rgb(51, 49, 49); margin-left:0px;"
                                                                                type="checkbox" value=""
                                                                                name="color_seis" id="color_seis_id">
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <div class="col-2 col-md-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                style="border: 1px solid rgb(51, 49, 49); margin-left:0px;"
                                                                                type="checkbox" value=""
                                                                                name="color_siete" id="color_siete_id">
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <div class="col-2 col-md-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                style="border: 1px solid rgb(51, 49, 49); margin-left:0px;"
                                                                                type="checkbox" value=""
                                                                                name="color_ocho" id="color_ocho_id">
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <div class="col-2 col-md-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                style="border: 1px solid rgb(51, 49, 49); margin-left:0px;"
                                                                                type="checkbox" value=""
                                                                                name="color_nueve" id="color_nueve_id">
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <div class="col-2 col-md-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                style="border: 1px solid rgb(51, 49, 49); margin-left:0px;"
                                                                                type="checkbox" value=""
                                                                                name="color_diez" id="color_diez_id">
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                    ...
                    <p class="text-center" style="margin-top: 25px;">
                        <button type="submit" class="btn btn-success" style="font-size:15px;"><i
                                class="far fa-save"></i> &nbsp;
                            GUARDAR</button>
                    </p>
                </form>
    ...
    <script src="js/registraAuto.js"></script>
